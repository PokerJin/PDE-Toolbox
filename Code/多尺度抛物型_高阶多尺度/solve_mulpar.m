function solve_mulpar(xyt_range,Nmmtp,equ_para,u0,bc_type,bc_para,shape)
if bc_type(1)==1
...
switch shape
    case 'circle'
        solve_mulpar_circle(xyt_range,Nmmtp,equ_para,u0,bc_type,bc_para)
    case 'square'
        solve_mulpar_square(xyt_range,Nmmtp,equ_para,u0,bc_type,bc_para)
    otherwise
        disp('无该形状')
end